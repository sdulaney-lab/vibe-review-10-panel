...
A comprehensive **10-judge AI panel** evaluation system for applications, featuring specialized judges with mathematical behavioral calibration and P0-P3 severity-weighted corrective prompts.
...
Vibe Review is a **multi-agent evaluation framework** that simulates 10 specialized AI judges, each with distinct expertise and behavioral calibration. The system:

1. **Collects Evidence** using Playwright browser automation (for URLs) or code analysis (for directories)
2. **Evaluates** through 10 specialized judge perspectives
...
| Profile | Security | Performance | UX | Visual | A11y | Infra | DX | Sustainability | Use Case |
|---------|----------|-------------|-----|--------|------|-------|-----|----------------|----------|
| `dev` | 0.4 | 0.4 | 0.6 | 0.4 | 0.3 | 0.2 | 0.4 | 0.2 | Local development |
| `hackathon` | 0.5 | 0.5 | 0.8 | 0.5 | 0.3 | 0.2 | 0.3 | 0.2 | Speed over polish |
| `mvp` | 0.7 | 0.7 | 0.9 | 0.7 | 0.6 | 0.5 | 0.5 | 0.5 | Minimum viable product |
| `staging` | 0.9 | 0.8 | 0.9 | 0.8 | 0.8 | 0.7 | 0.7 | 0.7 | Pre-production |
...
- 10 Corrective Prompts (one per judge)
